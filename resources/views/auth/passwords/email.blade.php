...
<div class="myheader" style="display: flex;
    ...
    <div class="login-box">
        ...
        <div class="login-box-body mycolor2">
            <p class="login-box-msg" style="color: #fff">para enviarle el link de restablecimiento</p>
            <form action="{{ url('/password/email') }}" method="post">
                <input type="hidden" name="_token" value="{{ csrf_token() }}">
                <div class="form-group has-feedback">
                    <input type="email" class="form-control" placeholder="Escriba aqui su correo " name="email" value="{{ old('email') }}"/>
          ...
          {{--    <a href="{{ url('/login') }}" style="color: #fff">ir al login</a><br> --}}
        </div><!-- /.login-box-body -->
